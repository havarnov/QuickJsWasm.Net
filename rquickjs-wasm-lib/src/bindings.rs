...
macro_rules! __export_calculator_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_calculator_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:example:calc:calculator:encoded world"
)]
#[doc(hidden)]
...
@\x02\x01xy\x01yy\0y\x04\0\x03add\x01\0\x04\0\x17example:calc/calculator\x04\0\x0b\
